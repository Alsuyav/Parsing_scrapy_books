...
class PagesCrawlSpider(CrawlSpider):
    ...
    rules = (
        # правило для захода в книгу
        # в restrict_xpaths ссылка, по которой нужно переходить в книгу
        Rule(LinkExtractor(restrict_xpaths="//article[@class='product_pod']/h3/a"), callback="parse_item", follow=True),
        # правило перехода на следующую страницу
        # в restrict_xpaths ссылка, по которой нужно переходить на следующую страницу
